...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const Info1Widget(),
        ),
        FFRoute(
          name: 'Home',
          path: '/home',
        ...
        FFRoute(
          name: 'Accountsection',
          path: '/accountsection',
          builder: (context, params) => const AccountsectionWidget(),
        ),
        FFRoute(
          name: 'Categories',
          path: '/categories',
        ...
        FFRoute(
          name: 'Add_account',
          path: '/addAccount',
          builder: (context, params) => const AddAccountWidget(),
        ),
        FFRoute(
          name: 'Add_new_account',
          path: '/AccountsectionCopy',
          builder: (context, params) => const AddNewAccountWidget(),
        ),
        FFRoute(
          name: 'Profilepage',
          path: '/profilepage',
        ...
        FFRoute(
          name: 'breakdown_of_transactions',
          path: '/breakdownOfTransactions',
          builder: (context, params) => const BreakdownOfTransactionsWidget(),
        )
