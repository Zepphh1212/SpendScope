import '/components/upload_bottom_sheet_widget.dart';
            ...
            background: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0xFF109A00), Color(0xFF109A00)],
                  stops: [0.0, 1.0],
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'How much is your income for today? ',
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  borderRadius: 30.0,
                                  buttonSize: 50.0,
                                  fillColor: const Color(0xFF3539E3),
                                  icon: const Icon(
                                    Icons.paid_outlined,
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  borderRadius: 30.0,
                                  buttonSize: 50.0,
                                  fillColor: const Color(0xFF027309),
                                  icon: const FaIcon(
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  borderRadius: 30.0,
                                  buttonSize: 50.0,
                                  fillColor: const Color(0xFFF798A7),
                                  icon: const FaIcon(
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  borderRadius: 30.0,
                                  buttonSize: 50.0,
                                  fillColor: const Color(0xFF219CF7),
                                  icon: const Icon(
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  borderRadius: 30.0,
                                  buttonSize: 50.0,
                                  fillColor: const Color(0xFF64544E),
                                  icon: const Icon(
                                    Icons.add,
                                    color: Color(0xFFFAF7F7),
                                    size: 30.0,
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        await showModalBottomSheet(
                          ...
                          backgroundColor: const Color(0x77C8F7F7),
                          useSafeArea: true,
                          context: context,
                          builder: (context) {
                            return GestureDetector(
